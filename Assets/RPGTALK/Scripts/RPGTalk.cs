...
public class RPGTalk : MonoBehaviour {
    ...
    public delegate void NewTalkActionGeneral();
    public static event NewTalkActionGeneral OnNewTalkGeneral;
    ...
    public delegate void EndTalkActionGeneral();
    public static event EndTalkAction OnEndTalkGeneral;
	...
	public void NewTalk(string _lineToStart,string _lineToBreak){
        Debug.Log("called new talk with parameters");
    ...
    public void NewTalk(string _lineToStart, string _lineToBreak,MonoBehaviour _callbackScript, string _callbackFunction)
    {
        lineToStart = _lineToStart;
        lineToBreak = _lineToBreak;
	...
	public void NewTalk(){
        ...
        if (OnNewTalkGeneral != null)
        {
            //Debug.Log("new tlak general called");
            OnNewTalkGeneral();
            count++;
        }
	...
	public void PlayNext(bool forcePlay = false) {
		...
		if(cutscenePosition <= rpgtalkElements.Count) {
            ...
            Debug.Log("Called dialog endC:");
            //call the event
            if (OnEndTalk != null){
				OnEndTalk ();
			}
            if(OnEndTalkGeneral != null)
            {
                OnEndTalkGeneral();
            }
